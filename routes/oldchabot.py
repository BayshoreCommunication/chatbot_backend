...
#                 # Do not force name collection on exception; continue normal flow
#                 print(f"[DEBUG] Error in AI name extraction (skipping lead prompt due to threshold policy): {str(e)}")
#                 pass
