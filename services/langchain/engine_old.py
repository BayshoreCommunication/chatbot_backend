...
def ask_bot(query: str, mode="faq", user_data=None, available_slots=None, session_id=None, api_key=None):
    """Process user query using a central AI-driven approach - OLD VERSION (Always collects info)"""
    ...
    # OLD VERSION: Always needs info (no leadCapture check)
    ...
    # STEP 0: OLD VERSION - If this is first message and we need user info, always collect name first
    ...
    # STEP 2: OLD VERSION - Handle Information Collection (always if needed)
